...
class FontEndController extends Controller {
    ...
    function __construct() {
        ...
        $login=array('Goods/buy','Goods/zhifu','Goods/gmcg','Goods/getUniqueOrderNo','Goods/alipay','Goods/notifyweixin','Goods/notify','Goods/gmcg_wx','Goods/sellection_join');//需要登录的方法
